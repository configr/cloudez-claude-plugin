---
name: dev
description: Sobe o site do usuário localmente em container e abre no navegador do Claude Code. Use quando ele pedir para rodar, subir, testar ou ver o site na máquina dele — "roda aqui", "abre no navegador", "quero ver antes de publicar" — e não para publicar, que é a skill de deploy.
---
...
Toda a lógica vive em `commands/dev.md`: como achar a porta publicada, o
`.claude/launch.json`, subir pelo painel de navegador e ler os logs quando não
responde. Se precisar consultar o procedimento, leia esse arquivo — não
